...
<!-- <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <header class="header-img" style="margin: 80px 0px 10px;">
        <div class="container align-items-center justify-items-center" style="height: auto;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="mb-3" style="font: Montserrat; text-align: center; color: white; margin-top: 100px;">Buy surplus food at a discount</h1>
                    <div style="font: Montserrat; text-align: center; color: white;">Grabbing worthy deals and reducing food waste at the same time!</div>
                    <br><br>
                </div>
            </div>
            <div class ='row'>
                ...
                <!-- <div class="form-group col-8" style="margin: 30px 0px 20px;"> -->
                    <input type="text" class="form-control" name="x" id="search_for_products"  placeholder="Search for products">
                ...
                <div class="col-lg-2" style="margin: 30px 0px 30px;">
                  <button class="btn btn-success" href="view_products.php">Search</button>
                </div>
            </div>
